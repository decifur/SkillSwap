...
const Login = () => {
    return (
     <>
     <div className="w-screen box min-h-screen flex ">
        <div className="w-6/12 min-h-full flex items-center justify-center">
            <img className="p-3 md:w-40" src="/public/14EED69F-62D1-46EB-B34A-EA48F2E25922-removebg-preview.png" width={200} alt="" />
            <div className="p-5">
        ...
        <div className="w-6/12 h-full flex items-center justify-center flex-col  p-12"> 
            <div className="box w-full h-full  flex items-center shadow-2xl shadow-cyan-200 rounded-xl flex-col">
            <h1 className="text-8xl p-10 text-blue-400 title font-bold">Login</h1>
                ...
                <div className="flex items-center gap-6 w-52 py-5 px-7">
